...
class DataLoader:
    ...
    def __init__(self, task_num: int = 0, test_size: float = 0.33):
    ...
    def get_train_test(self, data_x, data_y):
        self.x_train, self.x_test, self.y_train, self.y_test = train_test_split(data_x, data_y, test_size=self.test_size
